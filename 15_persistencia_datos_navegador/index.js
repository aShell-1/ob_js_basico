...
sessionStorage.setItem('user-session', JSON.stringify(midata))
localStorage.setItem('user-local', JSON.stringify(midata))

document.cookie = 'misgalletas='+ JSON.stringify(midata) +'; expires='+ new Date((new Date()).getTime() + 120000).toUTCString()